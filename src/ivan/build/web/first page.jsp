...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td height="90"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="500" height="60" background="images/top.jpg">&nbsp;</td>
                    <td align="right" background="images/top.jpg"><img src="images/home.jpg" width="70" height="50" style="cursor:pointer;" onClick="goiframes('main.html');">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/exit.jpg" width="70" height="50" style="cursor:pointer;" >&nbsp;</td>
                </tr>
                <tr>
    ...
    <tr>
        <td><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="174" valign="top" bgcolor="#CBE0FD" id="trmenu" style="display:table-cell;"><table width="174" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="menu_item"><a  onClick="goiframes('main.html');">系统首页</a></td>
                                        </tr>
                                        
                                        <tr>
                                            <td class="menu_item"><a  onClick="goiframes('newslist1.html');">修改记录值</a></td>
                                        </tr>
                                       
										 
                                        <tr>
                                            <td class="menu_item"><a  onClick="goiframes('');">我的DNS记录</a></td>
                                        </tr>

                                        <tr>
                                            <td class="menu_item">退出系统</td>
                                        </tr>
                                    </table></td>
                            </tr>
                            <tr>
                    ...
                    <td valign="top"><iframe src=""  height="100%" width="100%"  name="mainiframes" id="mainiframes"  frameborder="0" scrolling="auto"></iframe></td>
    </tr>
</table></td>
</tr>
</table>
